...
sentence = 'A black race car starts up in front of a crowd of people. A black race car starts up in front of a crowd of people. \n'
# sentence = " "
print(sentence)
...
print("Score: {}".format(model.score(sentence)))
